    ...
    <div class="w-full grid grid-cols-4 gap-10">
        ...
        <div id="side-bar"
            ...
            <div id="search-box">
                ...
                <div class="w-52 flex items-center rounded-2xl bg-gray-100 py-2 px-3 mb-3">
                    <span>
                    ...
                    <input class="w-40 ml-1 bg-transparent focus:outline-none text-xs text-gray-800 placeholder:text-gray-400"
